...
using SqlSugar;
using HR.CodeGenerator;
using HR.CodeGenerator.Model;
using HR.CodeGenerator.Service;
using HR.Model;
...
namespace HR.Admin.WebApi.Controllers
{
    ...
    public class CodeGeneratorController : BaseController
    {
        ...
        public IActionResult CodeGenerate([FromBody] GenerateDto dto)
        {
            ...
            //生成压缩包
            string zipReturnFileName = $"HrAdmin.NET-{dto.GenTable.TableName}-{DateTime.Now:MMddHHmmss}.zip";
