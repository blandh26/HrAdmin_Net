...
namespace HR.Admin.WebApi.Extensions
{
        ...
        public static void AddSwaggerConfig(this IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(c =>
            {
                ...
                try
                {
                    ...
                    c.IncludeXmlComments(Path.Combine(baseDir, "HR.Model.xml"), true);
                    c.IncludeXmlComments(Path.Combine(baseDir, "HR.ServiceCore.xml"), true);
                    c.IncludeXmlComments(Path.Combine(baseDir, "HR.Service.xml"), true);
                    c.IncludeXmlComments(Path.Combine(baseDir, "HR.Admin.WebApi.xml"), true);
